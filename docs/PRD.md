...
- **FR-021:** The system shall log all critical modify operations (create, update, delete) to an audit log.
- **FR-022:** The system shall record the user ID, tenant ID, action type, and IP address for every audited event.
